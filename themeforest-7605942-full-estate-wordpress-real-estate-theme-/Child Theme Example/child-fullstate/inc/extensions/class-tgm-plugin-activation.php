...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source' => get_template_directory_uri() .'/inc/plugins/advanced-custom-fields.zip',
            'required' => true,
            'version' => '4.3.9',
	   ...
	   // Options Framework
        array(
            'name' => 'options-framework.1.8.2',
            'slug' => 'options-framework',
            'source' => get_template_directory_uri() .'/inc/plugins/options-framework.1.8.2.zip',
            'required' => true,
            'version' => '1.8.2',
            'force_activation' => false,
            'force_deactivation' => false
		...
		// Meta Data Filter
        array(
            'name' => 'Meta Data Filter',
            'slug' => 'meta-data-filter',
            'source' => get_template_directory_uri() .'/inc/plugins/meta-data-filter.zip',
            'required' => true,
            'version' => '1.0.9',
            'force_activation' => false,
            'force_deactivation' => false
        ...
        array(
            'name' => 'wp-google-maps',
            'slug' => 'wp-google-maps',
            'source' => get_template_directory_uri() .'/inc/plugins/wp-google-maps.zip',
            'required' => true,
            'version' => '6.0.31',
            'force_activation' => false,
            'force_deactivation' => false
        ...
        array(
            ...
            'slug' => 'wp-google-maps-pro',
            'source' => get_template_directory_uri() .'/inc/plugins/wp-google-maps-pro.zip',
            'required' => true,
            'version' => '5.43',
            'force_activation' => false,
            'force_deactivation' => false
        ...
        array(
            'name' => 'contact-form-7',
            'slug' => 'contact-form-7',
            'source' => get_template_directory_uri() .'/inc/plugins/contact-form-7.4.0.2.zip',
            'required' => true,
            'version' => '4.0.1',
            'force_activation' => false,
            'force_deactivation' => false
				...
				// Newsletter
        array(
            'name' => 'mailchimp.1.4.2',
            'slug' => 'mailchimp',
            'source' => get_template_directory_uri() .'/inc/plugins/mailchimp.1.4.2.zip',
            'required' => true,
            'version' => '1.4.2',
            'force_activation' => false,
            'force_deactivation' => false
        ...
        array(
            ...
            'source' => get_template_directory_uri() .'/inc/plugins/wordpress-importer.zip',
            'required' => true,
            'version' => '0.6.1',
            'force_activation' => false,
            'force_deactivation' => false
        ...
        array(
            ...
            'source' => get_template_directory_uri() .'/inc/plugins/shortcodes-ultimate.zip',
            'required' => true,
            'version' => '4.9.3',
            'force_activation' => false,
            'force_deactivation' => false
        ), 
      	// twitters-bootstrap-shortcodes-ultimate-master
        array(
            'name' => 'twitters-bootstrap-shortcodes-ultimate',
            'slug' => 'twitters-bootstrap-shortcodes-ultimate',
            'source' => get_template_directory_uri() .'/inc/plugins/twitters-bootstrap-shortcodes-ultimate.1.0.4.zip',
            'required' => true,
            'version' => '1.0.4',
            'force_activation' => false,
            'force_deactivation' => false
